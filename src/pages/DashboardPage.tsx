  ...
  return (
    <DashboardLayout title="Grow Labs · Gestión de comprobantes">
      {sidebarView === 'simon' ? (<div style={{height: '100%'}}><SimonPanel /></div>) : (<div className="space-y-8 animate-in fade-in duration-700">
        ...
        <footer className="bg-white shadow-sm border border-neutral-200 rounded-xl mt-16 py-12">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 mb-8">
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-neutral-800 tracking-tight">GROW LABS</h3>
                    <p className="text-primary-500 text-sm font-bold uppercase tracking-widest">Innovation Powered</p>
                  </div>
                </div>
                <p className="text-neutral-500 mb-6 leading-relaxed max-w-md">
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    ...
                    className="flex items-center gap-2 bg-neutral-50 hover:bg-neutral-100 hover:from-pink-500/40 hover:to-orange-500/40 border border-neutral-200 text-neutral-800 px-5 py-2.5 rounded-full transition-all"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 bg-primary-50 hover:bg-primary-100 border border-primary-200 text-primary-500 px-5 py-2.5 rounded-full transition-all"
                  >
              ...
              <div className="bg-neutral-50 backdrop-blur-sm rounded-3xl p-8 border border-neutral-200 relative overflow-hidden group">
                <div className="absolute -right-8 -top-8 w-24 h-24 bg-primary-50 blur-3xl rounded-full group-hover:bg-primary-100 transition-all duration-700" />
                <h4 className="text-xl font-black text-neutral-800 mb-4 flex items-center gap-3">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-2xl font-black text-neutral-800 tracking-tight group-hover:text-primary-500 transition-colors">Sanatorio Argentino</p>
                    <p className="text-neutral-500 text-xs font-bold uppercase tracking-widest mt-1">San Juan, Argentina</p>
                  </div>
            ...
            <div className="border-t border-neutral-200 pt-8 mt-4 text-center">
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className=" bg-white shadow-sm border border-neutral-200 rounded-xl flex-1">
          <div
            className="px-6 py-5 flex-shrink-0 bg-neutral-50/20 border-b border-neutral-200"
          >
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-black text-neutral-800 tracking-tight">COMPROBANTES RECIENTES</h2>
          ...
          <div className="flex-1 overflow-y-auto">
            {loading ? (
              <div className="p-12 text-center">
                <div className="inline-block w-8 h-8 border-2 border-primary-200 border-t-grow-neon rounded-full animate-spin mb-4" />
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-neutral-500">Cargando datos...</p>
              </div>
            ) : error ? (
              ...
              <div className="p-12 text-center text-neutral-500 text-sm font-bold uppercase tracking-widest">
                    ...
                    <tr className="bg-white border-b border-neutral-200">
                      <th className="px-4 py-4 text-center">
                        <input
                          ...
                          className="w-4 h-4 rounded border-neutral-200 bg-white text-primary-500 focus:ring-grow-neon focus:ring-offset-0 cursor-pointer"
                        />
                      </th>
                      <th className="px-6 py-4 text-left text-[10px] font-black uppercase tracking-[0.2em] text-neutral-500">
                        Fecha
                      </th>
                      <th className="px-6 py-4 text-left text-[10px] font-black uppercase tracking-[0.2em] text-neutral-500">
                        Proveedor
                      ...
                      <th className="px-6 py-4 text-right text-[10px] font-black uppercase tracking-[0.2em] text-neutral-500">
                        Total
                      </th>
                      <th className="px-6 py-4 text-center text-[10px] font-black uppercase tracking-[0.2em] text-neutral-500">
                        Estado
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-white/5">
                    {formattedInvoices.map((invoice) => {
                      ...
                      return (
                        <tr
                          key={invoice.id}
                          className={`group transition-all duration-300 cursor-pointer ${isActive ? 'bg-primary-50' : 'hover:bg-neutral-50'
                            }`}
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-sm font-bold text-neutral-600 group-hover:text-neutral-800 transition-colors">
                            {invoice.formattedDate}
                          </td>
                          <td className="px-6 py-4 text-sm font-black text-neutral-800 group-hover:text-primary-500 transition-colors">
                            {invoice.supplier_name}
                          </td>
                          <td className="px-6 py-4">
                            <div className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 group-hover:text-neutral-500">
                              {invoice.invoice_type} · {invoice.point_of_sale}-{invoice.invoice_number}
                            </div>
                          </td>
                          <td className="px-6 py-4 text-sm text-right font-black text-neutral-800">
        ...
        <div className="bg-white shadow-sm border border-neutral-200 rounded-xl flex-1 min-h-[500px] flex flex-col">
          {selectedInvoiceId ? (
            <InvoiceEditor
            ...
            <div className="flex h-full flex-col items-center justify-center p-12 text-center">
              <div className="w-16 h-16 bg-neutral-50 rounded-full flex items-center justify-center mb-6 border border-neutral-200">
                <Globe className="w-8 h-8 text-primary-500 opacity-50" />
              </div>
              <h3 className="text-lg font-black text-neutral-800 tracking-tight uppercase">Editor de Comprobante</h3>
              <p className="text-xs text-neutral-500 font-bold uppercase tracking-widest mt-2 max-w-xs leading-relaxed">
...
function ExportPanel({ refreshKey, profileId, onExportCompleted }: ExportPanelProps) {
  ...
  return (
    <div className="space-y-8">
      <div className="rounded-3xl p-8 bg-primary-50 border border-primary-200 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-primary-50 blur-[100px] -mr-32 -mt-32" />
        <h3 className="text-2xl font-black text-neutral-800 tracking-tight uppercase flex items-center gap-3">
          <Globe className="w-8 h-8 text-primary-500" />
          Exportación a Tango Gestión
        </h3>
        <p className="mt-2 text-sm text-neutral-500 font-medium max-w-2xl leading-relaxed">
      ...
      {message && (
        <div className="rounded-2xl px-6 py-4 bg-primary-50 border border-primary-200 text-primary-500 text-sm font-bold uppercase tracking-widest">
          {message}
        </div>
      )}

      <div className="grid gap-6 sm:grid-cols-2">
        <div className="bg-white shadow-sm border border-neutral-200 rounded-xl p-8 group hover:border-primary-300 transition-all">
          <p className="text-xs font-black uppercase tracking-[0.2em] text-neutral-500 group-hover:text-primary-500 transition-colors">Comprobantes Listos</p>
          <p className="mt-4 text-6xl font-black text-neutral-800 tracking-tighter">
            {loading ? '...' : readyInvoices.length}
          </p>
        </div>
        <div className="bg-white shadow-sm border border-neutral-200 rounded-xl p-8 group hover:border-primary-300 transition-all">
          <p className="text-xs font-black uppercase tracking-[0.2em] text-neutral-500 group-hover:text-primary-500 transition-colors">Monto Proyectado</p>
          <p className="mt-4 text-4xl font-black text-neutral-800 tracking-tighter">
            {loading
              ? '...'
      ...
      <button
        ...
        className="bg-primary-500 text-white hover:bg-primary-600 rounded-lg shadow-sm transition-colors uppercase tracking-[0.2em] text-xs font-black w-full sm:w-auto"
      >
        {exporting ? 'GENERANDO PAQUETE...' : 'INICIAR EXPORTACIÓN TANGO'}
      </button>

      <div className="bg-white shadow-sm border border-neutral-200 rounded-xl p-6 bg-white/[0.02]">
        <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-[0.15em] leading-relaxed">
          El motor generará un archivo dinámico <span className="text-neutral-800">Excel (.xlsx)</span> estructurado en tres matrices de datos:
