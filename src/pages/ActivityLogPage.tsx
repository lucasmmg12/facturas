...
export function ActivityLogPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-neutral-900">Historial de Actividades</h2>
            ...
            <div key={dayIndex} className="bg-white rounded-lg shadow overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 px-6 py-4 border-b border-neutral-200">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-neutral-900 capitalize">{day.date}</h3>
              ...
              <div className="divide-y divide-neutral-200">
                ...
                {day.exports.map((exportItem, exportIndex) => (
                  <div key={exportIndex} className="p-4 hover:bg-neutral-50 transition-colors">
